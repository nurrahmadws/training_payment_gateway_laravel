...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="/">Our onation</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="{{url('donation')}}">Donation <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-4">Our onation</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="donator" class="form-control" id="donator">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">E-Mail</label>
                        <input type="email" name="donator_email" class="form-control" id="donator_email">
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <script>
        $("#donation_form").submit(function(event) {
            ...
            $.post("/api/donation", {
                _method: 'POST',
                _token: '{{ csrf_token() }}',
                donator: $('input#donator').val(),
                donator_email: $('input#donator_email').val(),
